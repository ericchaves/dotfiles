...
(defconst cloudformation-intrinsic-functions-re "\\(\"\\(Fn::Base64\\|Fn::FindInMap\\|Fn::GetAtt\\|Fn::GetAZs\\|Fn::ImportValue\\|Fn::Join\\|Fn::Select\\|Fn::Sub\\|Ref\\)\"[ ]*:\\)")
(defconst cloudformation-condition-functions-re "\\(\"\\(Fn::And\\|Fn::Equals\\|Fn::If\\|Fn::Not\\|Fn::Or\\)\"[ ]*:\\)")
...
(defconst cloudformation-font-lock-keywords-1
  (list
   ...
   (list cloudformation-condition-functions-re 1 font-lock-reference-face)
